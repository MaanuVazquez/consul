class NotificationsController < ApplicationController
  ...
  def show
    ...
    if @notification.linkable_resource.is_a?(Budget::Investment)
      redirect_to budget_investment_path(@notification.linkable_resource.budget, @notification.linkable_resource, anchor:"comments")
    else
